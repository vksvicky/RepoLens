...
| Phase / Track | GitHub | Status / Notes |
|---------------|--------|----------------|
...
| ↳ G4 Architecture DSL + weighted LLM | [#37](https://github.com/vksvicky/RepoLens/issues/37) | [~] [#48](https://github.com/vksvicky/RepoLens/pull/48) |
...
## Wave A — Gate honesty interrupt (#13)

**Goal:** Restore credibility and mathematical honesty to CI gate decisions (prevent 2 CVE advisories exploding into 6 Critical/High penalties, floor genuine vacuous clean passes, and clarify review adequacy vs "% secure" copy) before resuming Phase 7.
...
| G2 Cyclicity baseline + diff-aware CI | [#35](https://github.com/vksvicky/RepoLens/issues/35) | [~] [#48](https://github.com/vksvicky/RepoLens/pull/48) | Git-friendly baseline; runtime cycles hard-fail; PR upcoming |
